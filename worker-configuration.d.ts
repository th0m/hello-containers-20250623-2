/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5452653965e8bd4a5df3241ae446b713)
...
declare namespace Cloudflare {
	interface Env {
		...
		MY_CONTAINER2: DurableObjectNamespace<import("./src/index").MyContainer2>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MYSECRET">> {}
}
